...
pulp-runtime:
	git clone https://github.com/pulp-platform/pulp-runtime.git -b runner
...
test-runtime-gitlab: pulp-runtime
	...
	source pulp-runtime/configs/pulpissimo.sh; \
        cd tests && ../pulp-runtime/bwruntests.py --proc-verbose -v --report-junit -t 3600 --yaml -o simplified-runtime.xml runtime-tests.yaml
